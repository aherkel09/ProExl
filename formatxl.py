...
class Pyxl():
    def __init__(self, template):
        ...
        self.activeColumns = {
            ...
            'MaterialCost':[20, '1.5'], 'MaterialConversion':[21, '1.156'], 'MaterialRounding':[22,'None'],
            'MaterialUnit':[23, 'LB'], 'MaterialWastepercentage':[24, '0'], 'LaborCost':[27, '75'],
            'LaborConversion':[28, '0.75'], 'LaborRounding':[29, 'None'], 'LaborUnit':[30, 'HR'],
